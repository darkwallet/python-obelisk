...
class BCDataStream(object):
    ...
    def read_string(self):
        ...
        # 0 to 252 :
        #     1-byte-length followed by bytes (if any)
        # 253 to 65,535 :
        #     byte'253' 2-byte-length followed by bytes
        # 65,536 to 4,294,967,295 :
        #     byte '254' 4-byte-length followed by bytes
...
opcodes = Enumeration("Opcodes", [
    ...
    "OP_15", "OP_16",
    "OP_NOP", "OP_VER", "OP_IF", "OP_NOTIF", "OP_VERIF",
    ...
    "OP_OVER", "OP_PICK", "OP_ROLL", "OP_ROT",
    "OP_SWAP", "OP_TUCK", "OP_CAT", "OP_SUBSTR",
    "OP_LEFT", "OP_RIGHT",
    "OP_SIZE", "OP_INVERT", "OP_AND",
    "OP_OR", "OP_XOR", "OP_EQUAL", "OP_EQUALVERIFY",
    "OP_RESERVED1", "OP_RESERVED2", "OP_1ADD", "OP_1SUB", "OP_2MUL",
...
def match_decoded(decoded, to_match):
    ...
    for i in range(len(decoded)):
        if to_match[i] == opcodes.OP_PUSHDATA4 and\
           decoded[i][0] <= opcodes.OP_PUSHDATA4 and\
           decoded[i][0] > 0:
            # Opcodes below OP_PUSHDATA4 all just push data
            # onto stack, and are equivalent.
            continue
